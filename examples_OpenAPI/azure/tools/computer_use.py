...
"""
This example demonstrates how to use the ComputerTool with Azure OpenAI.
The agent uses a Playwright browser to search for sports news and provide a summary.
"""
...
async def main():
    ...
    # Create Azure OpenAI model settings for computer use
    azure_settings = ModelSettings(
        provider="azure_openai",  # Specify Azure OpenAI as the provider
        truncation="auto",  # Required for computer use model
    ...
    async with LocalPlaywrightComputer() as computer:
        with trace("Computer use example"):
            agent = Agent(
                ...
                model="computer-use-preview",  # Using the computer use model
                model_settings=azure_settings,
            )
            result = await Runner.run(agent, "Search for SF sports news and summarize.", run_config=run_config)
...
if __name__ == "__main__":
    ...
    print("Azure OpenAI Computer Use Example")
    print("===============================")
