...
"""
This example demonstrates a customer service system using Azure OpenAI.
It features:
- Context sharing between agents
- Tool usage for lookups and updates
...
async def main():
    ...
    while True:
        ...
        with trace("Customer service", group_id=conversation_id):
            ...
            result = await Runner.run(current_agent, input_items, context=context, run_config=run_config)
...
if __name__ == "__main__":
    ...
    print("Azure OpenAI Customer Service Example")
    print("===================================")
