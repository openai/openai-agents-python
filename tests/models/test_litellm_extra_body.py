...
@pytest.mark.allow_call_model_methods
@pytest.mark.asyncio
async def test_reasoning_summary_downgrades_to_string_for_anthropic_models(monkeypatch):
    """
    Anthropic LiteLLM routes expect string-valued reasoning_effort, so summary should not force
    the OpenAI-style structured payload.
    """
    from openai.types.shared import Reasoning
