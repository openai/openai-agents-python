...
def test_docker_runner_stream_event_banner_uses_stable_event_names() -> None:
    assert _stream_event_banner("tool_called") == "[tool call] shell"
    assert _stream_event_banner("tool_output") == "[tool output] shell"
    assert _stream_event_banner("message_output_created") is None
