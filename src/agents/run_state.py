...
SCHEMA_VERSION_SUMMARIES: dict[str, str] = {
    ...
    "1.18": (
        ...
        "Session write, including the response it belongs to and the conversion policy its "
        "items were registered under, so an approval resume can settle it under the "
