...
class ToolCallOutputItem(RunItemBase[Any]):
    ...
    def call_id(self) -> str | None:
        ...
        """
        if isinstance(self.raw_item, dict):
            return cast("str | None", self.raw_item.get("call_id") or self.raw_item.get("id"))
        return cast("str | None", getattr(self.raw_item, "call_id", None) or getattr(self.raw_item, "id", None))
