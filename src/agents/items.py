...
class ModelResponse:
    ...
    def to_input_items(self) -> typing.List[TResponseInputItem]:
...
class ItemHelpers:
    ...
    def input_to_new_input_list(
        cls, input: str | typing.List[TResponseInputItem]
    ) -> typing.List[TResponseInputItem]:
    ...
    @classmethod
    def text_message_outputs(cls, items: typing.List[RunItem]) -> str:
