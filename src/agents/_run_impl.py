...
class AgentToolUseTracker:
    agent_to_tools: typing.List[typing.Tuple[Agent, typing.List[str]]] = field(default_factory=list)
    """Tuple of (agent, list of tools used). Can't use a dict because agents aren't hashable."""

    def add_tool_use(self, agent: Agent[Any], tool_names: typing.List[str]) -> None:
...
class ProcessedResponse:
    ...
    handoffs: typing.List[ToolRunHandoff]
    functions: typing.List[ToolRunFunction]
    computer_actions: typing.List[ToolRunComputerAction]
    local_shell_calls: typing.List[ToolRunLocalShellCall]
    tools_used: typing.List[str]  # Names of all tools used, including hosted tools
    mcp_approval_requests: typing.List[ToolRunMCPApprovalRequest]  # Only requests with callbacks
...
class SingleStepResult:
    ...
    new_step_items: typing.List[RunItem]
    ...
    @property
    def generated_items(self) -> typing.List[RunItem]:
...
class RunImpl:
    ...
    async def execute_function_tool_calls(
        ...
        *,
        agent: Agent[TContext],
        tool_runs: typing.List[ToolRunFunction],
        hooks: RunHooks[TContext],
        context_wrapper: RunContextWrapper[TContext],
        config: RunConfig,
    ) -> typing.List[FunctionToolResult]:
    ...
    async def execute_local_shell_calls(
        ...
        *,
        agent: Agent[TContext],
        calls: typing.List[ToolRunLocalShellCall],
        context_wrapper: RunContextWrapper[TContext],
        hooks: RunHooks[TContext],
        config: RunConfig,
    ) -> typing.List[RunItem]:
        results: typing.List[RunItem] = []
    ...
    async def execute_computer_actions(
        ...
        *,
        agent: Agent[TContext],
        actions: typing.List[ToolRunComputerAction],
        hooks: RunHooks[TContext],
        context_wrapper: RunContextWrapper[TContext],
        config: RunConfig,
    ) -> typing.List[RunItem]:
    ...
    async def execute_handoffs(
        ...
        *,
        ...
        new_step_items: typing.List[RunItem],
        new_response: ModelResponse,
        run_handoffs: typing.List[ToolRunHandoff],
        hooks: RunHooks[TContext],
        context_wrapper: RunContextWrapper[TContext],
        run_config: RunConfig,
    ) -> SingleStepResult:
    ...
    async def execute_mcp_approval_requests(
        ...
        *,
        agent: Agent[TContext],
        approval_requests: typing.List[ToolRunMCPApprovalRequest],
        context_wrapper: RunContextWrapper[TContext],
    ) -> typing.List[RunItem]:
    ...
    async def _check_for_final_output_from_tools(
        ...
        *,
        agent: Agent[TContext],
        tool_results: typing.List[FunctionToolResult],
        context_wrapper: RunContextWrapper[TContext],
        config: RunConfig,
        ...
        if agent.tool_use_behavior == "run_llm_again":
            ...
            if inspect.iscoroutinefunction(agent.tool_use_behavior):
                return await cast(
                    typing.Awaitable[ToolsToFinalOutputResult],
