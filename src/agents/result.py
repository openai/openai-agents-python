...
class RunResultBase(abc.ABC):
    ...
    def final_output_as(self, cls: typing.Type[T], raise_if_incorrect_type: bool = False) -> T:
    ...
    def to_input_list(self) -> typing.List[TResponseInputItem]:
        """Creates a new input list, merging the original input with all the new items generated."""
        original_items: typing.List[TResponseInputItem] = ItemHelpers.input_to_new_input_list(self.input)
...
class RunResultStreaming(RunResultBase):
    ...
    async def stream_events(self) -> typing.AsyncIterator[StreamEvent]:
