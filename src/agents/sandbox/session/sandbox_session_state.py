...
class SandboxSessionState(BaseModel):
    ...
    _provider_identity_trusted: bool = PrivateAttr(default=False)
    ...
    @property
    def provider_identity_trusted(self) -> bool:
        """Whether the SDK observed this provider resource in the current process."""

        return self._provider_identity_trusted

    def _mark_provider_identity_trusted(self) -> None:
        self._provider_identity_trusted = True
    ...
    def _serialize_always_include_defaults(self, handler: Any) -> dict[str, Any]:
        ...
        from .._mount_security import (
            ...
            _raw_manifest_may_require_mount_authority_rebind,
        ...
        if (
            ...
            or _raw_manifest_may_require_mount_authority_rebind(sanitized_manifest)
        ):
