...
class RealtimeGuardrailsSettings(TypedDict):
    ...
    """
    The minimum number of characters to accumulate before running guardrails on transcript or
    text-output deltas. Defaults to 100. Guardrails run every time the accumulated text reaches
