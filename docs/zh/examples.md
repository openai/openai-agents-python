...
在[仓库](https://github.com/openai/openai-agents-python/tree/main/examples)的 examples 部分查看各种 SDK 示例实现。这些代码示例按多个目录组织，展示不同模式和能力。
...
-   **[voice](https://github.com/openai/openai-agents-python/tree/main/examples/voice):**
    查看语音智能体的示例，使用我们的 TTS 和 STT 模型，包括流式语音示例。