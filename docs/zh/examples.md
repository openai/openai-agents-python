...
请在 [repo](https://github.com/openai/openai-agents-python/tree/main/examples) 的示例部分查看该 SDK 的各种 sample code。示例按多个目录组织，展示了不同的模式和能力。
...
-   **[basic](https://github.com/openai/openai-agents-python/tree/main/examples/basic)：**
    ...
    -   结合 LiteLLM 的 Runner 管理重试（`examples/basic/retry_litellm.py`）
    -   非严格输出类型
    -   先前响应 ID 的使用
...
-   **[tools](https://github.com/openai/openai-agents-python/tree/main/examples/tools)：**
    ...
    -   使用命名空间和延迟工具的工具检索（`examples/tools/tool_search.py`）
    -   计算机操作
    -   图像生成
