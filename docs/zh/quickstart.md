...
可以用相同方式定义更多智能体。`handoff_descriptions` 提供用于确定任务转移路由的额外上下文。
...
要回顾智能体运行期间发生的事件，请前往 [OpenAI 控制台中的 Trace viewer](https://platform.openai.com/traces) 查看你的智能体运行追踪。
