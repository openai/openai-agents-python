...
!!! note
    ...
    LiteLLM 통합은 베타 상태입니다. 특히 규모가 작은 일부 모델 제공사와는 문제가 발생할 수 있습니다. 문제가 있으면 [Github issues](https://github.com/openai/openai-agents-python/issues)로 보고해 주세요. 빠르게 수정하겠습니다.
...
완전히 동작하는 예시입니다. 실행하면 모델 이름과 API 키 입력을 요청합니다. 예를 들어 다음처럼 입력할 수 있습니다:
