...
Realtime エージェントを使用すると、OpenAI の Realtime API で AI エージェントとの音声会話が可能になります。このガイドでは、初めての Realtime 音声エージェントの作成方法を説明します。
...
-   動作する code examples は [examples/realtime](https://github.com/openai/openai-agents-python/tree/main/examples/realtime) フォルダにあります
-   エージェントにツールを追加する
-   エージェント間のハンドオフを実装する
-   安全性のためにガードレールを設定する
