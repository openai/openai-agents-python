...
Realtime エージェントを使うと、 OpenAI の Realtime API を用いて AI エージェントとの音声会話が可能になります。本ガイドでは、最初のリアルタイム音声エージェントの作成手順を説明します。
...
-   `voice`: ボイスを選択 (`alloy`, `echo`, `fable`, `onyx`, `nova`, `shimmer`)
