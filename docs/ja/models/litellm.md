...
[LiteLLM](https://docs.litellm.ai/docs/) は、単一のインターフェースで 100+ のモデルを利用できるライブラリです。Agents SDK に LiteLLM 統合を追加しており、任意の AI モデルを使用できます。
...
LiteLLM の応答で Agents SDK の使用状況メトリクスを反映したい場合は、エージェント作成時に `ModelSettings(include_usage=True)` を渡してください。
