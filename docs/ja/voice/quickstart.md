...
Agents SDK の基本的な [クイックスタート手順](../quickstart.md) に従い、仮想環境を設定してください。続いて、SDK から音声向けのオプション依存関係をインストールします:
...
まず、いくつかのエージェントを設定しましょう。これは、この SDK でエージェントを作ったことがあれば見覚えがあるはずです。複数のエージェントと、ハンドオフ、およびツールを用意します。
