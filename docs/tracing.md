...
The SDK includes a built-in OpenTelemetry tracing processor that bridges agent traces to any OTLP-compatible backend (Jaeger, Datadog, Honeycomb, Grafana Tempo, etc.).
