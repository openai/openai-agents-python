...
async def main(model: str, question: str) -> None:
    ...
    async with MCPServerStdio(
        ...
        agent = SandboxAgent(
            ...
            model=model,
            # `instructions` is the base agent instructions for the multi-tool review task.
            instructions=(
            ...
            # `developer_instructions` is appended after that as additional deterministic
            # instructions. Here, the concise-answer constraint is kept there.
