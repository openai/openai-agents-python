...
from agents import Agent, InstructionOptimizer, LabeledExample, evaluate_agent
...
async def main() -> None:
    ...
    candidates = [
        INSTR,
        (
            "Extract an event with fields name, date, participants (list of strings). "
            "Respond as strict JSON only."
        ),
        (
            "You populate a CalendarEvent JSON object with keys name, date, participants. "
            "Only output JSON."
        ),
    ]
