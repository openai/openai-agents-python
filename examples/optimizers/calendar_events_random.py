...
from agents import Agent, BootstrapFewShotRandomSearch, LabeledExample, evaluate_agent
...
async def main() -> None:
    ...
    opt = BootstrapFewShotRandomSearch(max_examples=3, num_trials=16, base_instructions=INSTR)
